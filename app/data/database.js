...
// populate lawyers
spainLawyers.forEach(item => lawyersTable.insert({ ...item, country: 'spain' }))
thailandLawyers.forEach(item => lawyersTable.insert({ ...item, country: 'thailand' }))

// populate medical facilities
thailandMedicalFacilities.forEach(item => medicalFacilitiesTable.insert({ ...item, country: 'thailand' }))
